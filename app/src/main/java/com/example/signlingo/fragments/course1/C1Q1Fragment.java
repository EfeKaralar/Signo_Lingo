...
public class C1Q1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_c1_q1, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton btnA = view.findViewById(R.id.ibQ1A);
        ImageButton btnB = view.findViewById(R.id.ibQ1B);
        ImageButton btnC = view.findViewById(R.id.ibQ1C);
        ImageButton btnD = view.findViewById(R.id.ibQ1D);
