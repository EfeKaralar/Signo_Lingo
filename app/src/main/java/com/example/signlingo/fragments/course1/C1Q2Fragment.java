...
public class C1Q2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_c1_q2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton btnA = view.findViewById(R.id.ibQ2A);
        ImageButton btnB = view.findViewById(R.id.ibQ2B);
        ImageButton btnC = view.findViewById(R.id.ibQ2C);
        ImageButton btnD = view.findViewById(R.id.ibQ2D);
