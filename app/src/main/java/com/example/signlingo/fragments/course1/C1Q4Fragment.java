...
public class C1Q4Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_c1_q4, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton btnA = view.findViewById(R.id.ibQ4A);
        ImageButton btnB = view.findViewById(R.id.ibQ4B);
        ImageButton btnC = view.findViewById(R.id.ibQ4C);
        ImageButton btnD = view.findViewById(R.id.ibQ4D);
