...
public class C1Q5Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_c1_q5, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton btnA = view.findViewById(R.id.ibQ5A);
        ImageButton btnB = view.findViewById(R.id.ibQ5B);
        ImageButton btnC = view.findViewById(R.id.ibQ5C);
        ImageButton btnD = view.findViewById(R.id.ibQ5D);
